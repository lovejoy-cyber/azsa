          ...
          {universities.map((u) => (
            <div key={u.id} className="rounded-[var(--radius-md)] border border-border bg-surface p-5">
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="shrink-0 rounded-[var(--radius-xs)] bg-gold-100 px-2 py-0.5 font-mono text-xs text-ink-800">
              ...
              {u.website && (
                <a href={u.website} className="mt-2 inline-block text-sm font-semibold text-gold-700 hover:text-ink-800">
                  Visit website
                </a>
              )}
            </div>
